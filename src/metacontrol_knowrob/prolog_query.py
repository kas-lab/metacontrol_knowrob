...
class PrologQuery(object):
    ...
    def load_all_predicates(self):
        """ Load all available predicates.
        The knowrob ones are defined inside __init__.pl files, see
        https://github.com/knowrob/knowrob/blob/master/src/model/__init__.pl
        """
